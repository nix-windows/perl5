...
( ( 'A' == ((const U8*)s)[0] || 'a' == ((const U8*)s)[0] ) ?                \
	( ( ( 0xCA == ((const U8*)s)[1] ) && ( 0xBE == ((const U8*)s)[2] ) ) ? 0x1E9A : 0 )\
    : ( 'F' == ((const U8*)s)[0] || 'f' == ((const U8*)s)[0] ) ?            \
	( ( 'F' == ((const U8*)s)[1] || 'f' == ((const U8*)s)[1] ) ?        \
	    ( ( 'I' == ((const U8*)s)[2] || 'i' == ((const U8*)s)[2] ) ? 0xFB03\
	    : ( 'L' == ((const U8*)s)[2] || 'l' == ((const U8*)s)[2] ) ? 0xFB04 : 0xFB00 )\
	: ( 'I' == ((const U8*)s)[1] || 'i' == ((const U8*)s)[1] ) ? 0xFB01 \
	: ( 'L' == ((const U8*)s)[1] || 'l' == ((const U8*)s)[1] ) ? 0xFB02 : 0 )\
    : ( 'H' == ((const U8*)s)[0] || 'h' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xCC == ((const U8*)s)[1] ) && ( 0xB1 == ((const U8*)s)[2] ) ) ? 0x1E96 : 0 )\
    : ( 'I' == ((const U8*)s)[0] || 'i' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xCC == ((const U8*)s)[1] ) && ( 0x87 == ((const U8*)s)[2] ) ) ? 0x130 : 0 )\
    : ( 'J' == ((const U8*)s)[0] || 'j' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xCC == ((const U8*)s)[1] ) && ( 0x8C == ((const U8*)s)[2] ) ) ? 0x1F0 : 0 )\
    : ( 'S' == ((const U8*)s)[0] || 's' == ((const U8*)s)[0] ) ?            \
	( ( 'S' == ((const U8*)s)[1] || 's' == ((const U8*)s)[1] ) ? 0xDF   \
	: ( 'T' == ((const U8*)s)[1] || 't' == ((const U8*)s)[1] ) ? 0xFB05 \
	: ( ( 0xC5 == ((const U8*)s)[1] ) && ( 0xBF == ((const U8*)s)[2] ) ) ? 0xDF : 0 )\
    : ( 'T' == ((const U8*)s)[0] || 't' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xCC == ((const U8*)s)[1] ) && ( 0x88 == ((const U8*)s)[2] ) ) ? 0x1E97 : 0 )\
    : ( 'W' == ((const U8*)s)[0] || 'w' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xCC == ((const U8*)s)[1] ) && ( 0x8A == ((const U8*)s)[2] ) ) ? 0x1E98 : 0 )\
    : ( 'Y' == ((const U8*)s)[0] || 'y' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xCC == ((const U8*)s)[1] ) && ( 0x8A == ((const U8*)s)[2] ) ) ? 0x1E99 : 0 )\
    : ( 0xC5 == ((const U8*)s)[0] ) ?                                       \
	( ( 0xBF == ((const U8*)s)[1] ) ?                                   \
	    ( ( 'S' == ((const U8*)s)[2] || 's' == ((const U8*)s)[2] ) ? 0xDF\
	    : ( 'T' == ((const U8*)s)[2] || 't' == ((const U8*)s)[2] ) ? 0xFB05\
	    : ( ( 0xC5 == ((const U8*)s)[2] ) && ( 0xBF == ((const U8*)s)[3] ) ) ? 0xDF : 0 )\
	: 0 )                                                               \
    : ( 0xCA == ((const U8*)s)[0] ) ?                                       \
	( ( ( 0xBC == ((const U8*)s)[1] ) && ( 'N' == ((const U8*)s)[2] || 'n' == ((const U8*)s)[2] ) ) ? 0x149 : 0 )\
    : ( 0xCE == ((const U8*)s)[0] ) ?                                       \
	( ( 0xAC == ((const U8*)s)[1] ) ?                                   \
...
( ((e)-(s) > 2) ?                                                           \
	...
	( ( 0xBF == ((const U8*)s)[1] ) ?                                   \
	    ( ( 'S' == ((const U8*)s)[2] || 's' == ((const U8*)s)[2] ) ? 0xDF\
	    : ( 'T' == ((const U8*)s)[2] || 't' == ((const U8*)s)[2] ) ? 0xFB05 : 0 )\
	: 0 )                                                               \
    : ( ( ( 0xCA == ((const U8*)s)[0] ) && ( 0xBC == ((const U8*)s)[1] ) ) && ( 'N' == ((const U8*)s)[2] || 'n' == ((const U8*)s)[2] ) ) ? 0x149 : 0 )\
: ((e)-(s) > 1) ?                                                           \
    ( ( 'F' == ((const U8*)s)[0] || 'f' == ((const U8*)s)[0] ) ?            \
	( ( 'F' == ((const U8*)s)[1] || 'f' == ((const U8*)s)[1] ) ? 0xFB00 \
	: ( 'I' == ((const U8*)s)[1] || 'i' == ((const U8*)s)[1] ) ? 0xFB01 \
	: ( 'L' == ((const U8*)s)[1] || 'l' == ((const U8*)s)[1] ) ? 0xFB02 : 0 )\
    : ( 'S' == ((const U8*)s)[0] || 's' == ((const U8*)s)[0] ) ?            \
	( ( 'S' == ((const U8*)s)[1] || 's' == ((const U8*)s)[1] ) ? 0xDF   \
	: ( 'T' == ((const U8*)s)[1] || 't' == ((const U8*)s)[1] ) ? 0xFB05 : 0 )\
    : 0 )                                                                   \
: 0 )
...
( ( 'h' == ((const U8*)s)[0] || 'H' == ((const U8*)s)[0] ) ?                \
	...
	( ( 0x73 == ((const U8*)s)[1] ) ?                                   \
	    ...
	    : ( 's' == ((const U8*)s)[2] || 'S' == ((const U8*)s)[2] ) ? 0x59\
	    : ( 't' == ((const U8*)s)[2] || 'T' == ((const U8*)s)[2] ) ? 0xFB05 : 0 )\
	: 0 )                                                               \
    : ( 'j' == ((const U8*)s)[0] || 'J' == ((const U8*)s)[0] ) ?            \
	...
	: ( 's' == ((const U8*)s)[1] || 'S' == ((const U8*)s)[1] ) ? 0x59   \
	: ( 't' == ((const U8*)s)[1] || 'T' == ((const U8*)s)[1] ) ? 0xFB05 : 0 )\
    : ( 't' == ((const U8*)s)[0] || 'T' == ((const U8*)s)[0] ) ?            \
    ...
    : ( 0xAB == ((const U8*)s)[0] ) ?                                       \
	( ( ( 0x70 == ((const U8*)s)[1] ) && ( 'n' == ((const U8*)s)[2] || 'N' == ((const U8*)s)[2] ) ) ? 0x149 : 0 )\
    : ( 0xB4 == ((const U8*)s)[0] ) ?                                       \
	( ( 0x53 == ((const U8*)s)[1] ) ?                                   \
...
( ((e)-(s) > 2) ?                                                           \
    ...
    : ( 'y' == ((const U8*)s)[0] || 'Y' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xAF == ((const U8*)s)[1] ) && ( 0x51 == ((const U8*)s)[2] ) ) ? 0x1E99 : 0 )\
    : ( ( ( 0xAB == ((const U8*)s)[0] ) && ( 0x70 == ((const U8*)s)[1] ) ) && ( 'n' == ((const U8*)s)[2] || 'N' == ((const U8*)s)[2] ) ) ? 0x149 : 0 )\
: ((e)-(s) > 1) ?                                                           \
    ( ( 'f' == ((const U8*)s)[0] || 'F' == ((const U8*)s)[0] ) ?            \
	( ( 'f' == ((const U8*)s)[1] || 'F' == ((const U8*)s)[1] ) ? 0xFB00 \
	: ( 'i' == ((const U8*)s)[1] || 'I' == ((const U8*)s)[1] ) ? 0xFB01 \
...
( ((e)-(s) > 5) ?                                                           \
    ( ( 'a' == ((const U8*)s)[0] || 'A' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xAB == ((const U8*)s)[1] ) && ( 0x72 == ((const U8*)s)[2] ) ) ? 0x1E9A : 0 )\
    : ( 'f' == ((const U8*)s)[0] || 'F' == ((const U8*)s)[0] ) ? what_MULTI_CHAR_FOLD_utf8_safe_part2(s,e) : what_MULTI_CHAR_FOLD_utf8_safe_part3(s,e) )\
: ((e)-(s) > 4) ?                                                           \
    ( ( 'a' == ((const U8*)s)[0] || 'A' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xAB == ((const U8*)s)[1] ) && ( 0x72 == ((const U8*)s)[2] ) ) ? 0x1E9A : 0 )\
    : ( 'f' == ((const U8*)s)[0] || 'F' == ((const U8*)s)[0] ) ?            \
...
( ( 'h' == ((const U8*)s)[0] || 'H' == ((const U8*)s)[0] ) ?                \
    ...
    : ( 0xAA == ((const U8*)s)[0] ) ?                                       \
	( ( ( 0x6A == ((const U8*)s)[1] ) && ( 'n' == ((const U8*)s)[2] || 'N' == ((const U8*)s)[2] ) ) ? 0x149 : 0 )\
    : ( 0xB3 == ((const U8*)s)[0] ) ?                                       \
	( ( 0x53 == ((const U8*)s)[1] ) ?                                   \
...
( ((e)-(s) > 2) ?                                                           \
    ...
    : ( 'y' == ((const U8*)s)[0] || 'Y' == ((const U8*)s)[0] ) ?            \
	( ( ( 0xAD == ((const U8*)s)[1] ) && ( 0x51 == ((const U8*)s)[2] ) ) ? 0x1E99 : 0 )\
    : ( ( ( 0xAA == ((const U8*)s)[0] ) && ( 0x6A == ((const U8*)s)[1] ) ) && ( 'n' == ((const U8*)s)[2] || 'N' == ((const U8*)s)[2] ) ) ? 0x149 : 0 )\
: ((e)-(s) > 1) ?                                                           \
    ( ( 'f' == ((const U8*)s)[0] || 'F' == ((const U8*)s)[0] ) ?            \
	( ( 'f' == ((const U8*)s)[1] || 'F' == ((const U8*)s)[1] ) ? 0xFB00 \
	: ( 'i' == ((const U8*)s)[1] || 'I' == ((const U8*)s)[1] ) ? 0xFB01 \
 ...
 * 4814f3f43923b62a2046b2f74a8f26248af16e12d27eda330de2f41a1751cf4c regen/regcharclass.pl
 * e9ce5a7613b4f1f7e1ff9af49760b9c62c0d899ae4b8ce971e3a50d21bb526e7 regen/regcharclass_multi_char_folds.pl
 * ex: set ro: */
